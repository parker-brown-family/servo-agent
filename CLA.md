...
Thank you for your interest in contributing to **servo-agent** ("the Project"),
maintained by Brown Family Sports Inc. ("the Maintainer"). This Contributor
License Agreement ("Agreement") clarifies the intellectual-property license
granted with Contributions from any person or entity. It protects both You and
the Project, and it does **not** change Your right to use Your own Contributions
...
then-current open-source license (the Apache License 2.0). The additional rights granted to
the Maintainer in Sections 2 and 3 exist **alongside**, and do not diminish, that
public license. The free and open-source distribution of servo-agent for individual
developers is and remains the Project's commitment.
